...
const CATALOG: Record<string, Expected> = {
  ...
  seated_cable_row:          { posture: 'seated',   view: 'side',     vision: null },
  chest_supported_row:       { posture: 'prone',    view: 'side',     vision: null },
  t_bar_row:                 { posture: 'hinged',   view: 'side',     vision: null },
  single_arm_db_row:         { posture: 'hinged',   view: 'side',     vision: null },
  incline_barbell_press:     { posture: 'lying',    view: 'front_45',     vision: 'press' },
  decline_bench_press:       { posture: 'lying',    view: 'front_45',     vision: 'press' },
  close_grip_bench_press:    { posture: 'lying',    view: 'front_45',     vision: 'press' },
  flat_dumbbell_press:       { posture: 'lying',    view: 'front_45',     vision: 'press' },
  seated_dumbbell_press:     { posture: 'seated',   view: 'front',     vision: 'press' },
  machine_shoulder_press:    { posture: 'seated',   view: 'front',     vision: 'press' },
  seated_barbell_press:      { posture: 'seated',   view: 'front',     vision: 'press' },
  rotating_db_press:         { posture: 'seated',   view: 'front',    vision: 'press' },
  push_up:                   { posture: 'prone',    view: 'side',     vision: null },
  diamond_push_up:           { posture: 'prone',    view: 'side',     vision: null },
  tricep_dip:                { posture: 'standing', view: 'side',     vision: null },
