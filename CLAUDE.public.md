<!-- PUBLIC / SHAREABLE COPY of CLAUDE.md — safe to share with employees, agents, or in a public repo. Contains NO secrets, API keys, database URLs, project refs, tokens, or credentials. Verified scrubbed. Keep it that way: never paste a real key/ref/URL into this file. -->
