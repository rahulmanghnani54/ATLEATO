...
// Bundled ringtone — synthesised dual-tone (440/480 Hz, 2s on / 4s off cycle)
// Generated by scripts/generate-ringtone.js
const RINGTONE_ASSET = require('../assets/sounds/wakeup-ring.wav');
...
async function startPersistentRing(
  ...
  // 2. Load + play the bundled ringtone on loop.
  try {
