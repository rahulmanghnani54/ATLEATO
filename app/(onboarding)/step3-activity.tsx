    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          <Text style={styles.monoLabel}>STEP 3 OF 5</Text>
          <Text style={styles.headline}>ACTIVITY{'\n'}LEVEL?</Text>
          ...
          {LEVELS.map((l) => (
            ...
            >
              ...
              <View style={styles.cardText}>
                <Text style={[styles.cardTitle, selected === l.key && { color: Colors.primary }]}>{l.title}</Text>
